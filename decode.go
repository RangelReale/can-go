...
func decode(data *Data, startBit uint32, bitSize uint32, byteOrder ByteOrder, valueType ValueType) uint64 {
	/* safety check */
	if bitSize == 0 {
		return 0
	}
...
func encode(data *Data, startBit uint32, bitSize uint32, byteOrder ByteOrder, valueType ValueType, rawValue uint64) {
	/* safety check */
	if bitSize == 0 {
		return
	}
